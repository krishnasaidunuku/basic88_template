...
x = 0;
slider.appendChild(slide_a_ele);
slider.setAttribute("onmouseover", "mouseover()");
slider.setAttribute("onmouseout","mouseout()");

t=setTimeout("changeImage()");
